...
public class PaymentTypeDAO {
	...
	public List<PaymentType> GetPaymentTypes(){
		...
		String query = "Select * from ThuongMaiDienTu.PaymentTypes";
	...
	public PaymentType GetPaymentType(BigDecimal id) {
		...
		String query = "Select * from ThuongMaiDienTu.PaymentTypes where ID = ?";
	...
	public boolean CreatePaymentType(PaymentType paymentType) {
		String query = "Insert into ThuongMaiDienTu.PaymentTypes(\"name\", \"description\", createAt, updateAt) values(?, ?, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)";
	...
	public boolean UpdatePaymentType(PaymentType paymentType) {
		String query = "Update ThuongMaiDienTu.PaymentTypes set \"name\" = ?, \"description\" = ?, updateAt = CURRENT_TIMESTAMP where ID = ?";
	...
	public boolean DeletePaymentType(BigDecimal id) {
		String query = "Delete from ThuongMaiDienTu.PaymentTypes where ID = ?";
		int affected = jdbcTemplate.update(query, new Object[] { id });
		return (affected > 0);
	}
	
	public int CountPaymentType() {
		String query = "Select count(*) from ThuongMaiDienTu.PaymentTypes";
		int count = jdbcTemplate.queryForObject(query, Integer.class);
		return count;
	}
	
	public boolean IsExistPaymentTypeById(BigDecimal id) {
		String query = "Select count(*) from ThuongMaiDienTu.PaymentTypes where ID = ?";
	...
	public boolean IsExistPaymentTypeByName(String name) {
		String query = "Select count(*) from ThuongMaiDienTu.PaymentTypes where \"name\" = ?";
