...
public class ProductCategoryDAO {
	...
	public List<ProductCategory> GetProductCategories(){
		...
		String query = "Select * from ThuongMaiDienTu.ProductCategories";
	...
	public ProductCategory GetProductCategory(BigDecimal id) {
		...
		String query = "Select * from ThuongMaiDienTu.ProductCategories where ID = ?";
	...
	public boolean CreateProductCategory(ProductCategory productCategory) {
		String query = "Insert into ThuongMaiDienTu.ProductCategories(\"name\", \"description\", createAt, updateAt) values(?, ?, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)";
	...
	public boolean UpdateProductCategory(ProductCategory productCategory) {
		String query = "Update ThuongMaiDienTu.ProductCategories set \"name\" = ?, \"description\" = ?, updateAt = CURRENT_TIMESTAMP where ID = ?";
	...
	public boolean DeleteProductCategory(BigDecimal id) {
		String query = "Delete from ThuongMaiDienTu.ProductCategories where ID = ?";
		int affected = jdbcTemplate.update(query, new Object[] { id });
		return (affected > 0);
	}
	
	public int CountProductCategory() {
		String query = "Select count(*) from ThuongMaiDienTu.ProductCategories";
		int count = jdbcTemplate.queryForObject(query, Integer.class);
		return count;
	}
	
	public boolean IsExistProductCategoryById(BigDecimal id) {
		String query = "Select count(*) from ThuongMaiDienTu.ProductCategories where ID = ?";
	...
	public boolean IsExistProductCategoryByName(String name) {
		String query = "Select count(*) from ThuongMaiDienTu.ProductCategories where \"name\" = ?";
