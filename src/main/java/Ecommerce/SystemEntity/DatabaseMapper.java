	...
	public Database mapRow(ResultSet rs, int rowNum) throws SQLException {
		if(fullColumn)
			return new Database(rs.getBigDecimal("dbid"), rs.getString("name"), rs.getTimestamp("created"), rs.getBigDecimal("resetlogs_change#"),
					...
					rs.getTimestamp("controfile_created"), rs.getBigDecimal("controfile_sequence#"), rs.getBigDecimal("controfile_change#"),
					rs.getTimestamp("controfile_time"), rs.getString("open_resetlogs"), rs.getTimestamp("version_time"), rs.getString("open_mode"),
					...
					rs.getString("supplemental_log_data_fk"), rs.getString("supplemental_log_data_all"), rs.getString("db_uique_name"),
					...
					rs.getString("fs_failover_observer_host"), rs.getString("controfile_converted"), rs.getString("primary_db_uique_name"),
