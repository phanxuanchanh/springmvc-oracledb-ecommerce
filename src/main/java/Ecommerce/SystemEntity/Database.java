...
public class Database {
	...
	private Timestamp controfile_created;
	private BigDecimal controfile_sequence;
	private BigDecimal controfile_change;
	private Timestamp controfile_time;
	...
	private String controfile_converted;
	private String primary_db_uique_name;
	...
	public Timestamp getControfile_created() {
		return controfile_created;
	}
	public void setControfile_created(Timestamp controfile_created) {
		this.controfile_created = controfile_created;
	}
	public BigDecimal getControfile_sequence() {
		return controfile_sequence;
	}
	public void setControfile_sequence(BigDecimal controfile_sequence) {
		this.controfile_sequence = controfile_sequence;
	}
	public BigDecimal getControfile_change() {
		return controfile_change;
	}
	public void setControfile_change(BigDecimal controfile_change) {
		this.controfile_change = controfile_change;
	}
	public Timestamp getControfile_time() {
		return controfile_time;
	}
	public void setControfile_time(Timestamp controfile_time) {
		this.controfile_time = controfile_time;
	}
	...
	public String getDb_uique_name() {
		return db_uique_name;
	}
	public void setDb_uique_name(String db_uique_name) {
		this.db_uique_name = db_uique_name;
	}
	...
	public String getControfile_converted() {
		return controfile_converted;
	}
	public void setControfile_converted(String controfile_converted) {
		this.controfile_converted = controfile_converted;
	}
	public String getPrimary_db_uique_name() {
		return primary_db_uique_name;
	}
	public void setPrimary_db_uique_name(String primary_db_uique_name) {
		this.primary_db_uique_name = primary_db_uique_name;
	}
	...
	public Database(BigDecimal dbid, String name, Timestamp created, BigDecimal resetlogs_change,
			...
			Timestamp controfile_created, BigDecimal controfile_sequence, BigDecimal controfile_change,
			Timestamp controfile_time, String open_resetlogs, Timestamp version_time, String open_mode,
			...
			String supplemental_log_data_fk, String supplemental_log_data_all, String db_uique_name,
			...
			String fs_failover_observer_host, String controfile_converted, String primary_db_uique_name,
