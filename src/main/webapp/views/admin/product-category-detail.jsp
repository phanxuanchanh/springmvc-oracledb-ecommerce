...
<div class="card shadow mb-4">
	<div class="card-header py-3">
		<h6 class="m-0 font-weight-bold text-primary">Chi tiết thể loại "${ productCategory.name }"</h6>
	</div>
	<div class="card-body">
				...
				<table class="table table-bordered table table-hover">
					<tbody>
						...
						<tr>
							...
							<td>${ productCategory.createAt }</td>
						</tr>
						<tr>
							<th style="width: 25%;">Ngày cập nhật</th>
							<td>${ productCategory.updateAt }</td>
						</tr>
					</tbody>
				</table>
			</div>
	...
	<div class="card-footer">
		<a class="btn btn-primary"
			...
			href="<c:url value="/quan-tri/chinh-sua-the-loai/${ productCategory.ID }"></c:url>">Chỉnh sửa</a>
	</div>
</div>