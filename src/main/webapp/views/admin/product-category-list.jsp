								...
								<c:forEach var="item" items="${ productCategories }">
									<tr role="row">
										...
										<td>
											...
											<form:form id="deleteProductCategory${ item.ID }" method="POST" action="${ post_url }">
											...
											<button type="submit" class="btn btn-danger" form="deleteProductCategory${ item.ID }">Xóa</button>
										</td>
									</tr>
								</c:forEach>
							</tbody>
