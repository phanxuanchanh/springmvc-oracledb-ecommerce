...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-800">Trang quản trị/Chỉnh sửa Profile</h1>
	<div class="row">
		<div class="col">
...
<div class="row">
	<div class="col-lg-12 mb-4">
			<div class="card bg-danger text-white shadow">
				<div class="card-body">
					Cần cẩn thận khi chỉnh sửa profile, việc chỉnh sửa nhầm hoặc bị sai dữ liệu có thể gây ra lỗi nghiêm trọng đối với CSDL.
	...
	<div class="col-lg-12 mb-4">
		<c:if test="${ state != null }">
			<div class="card bg-secondary text-white shadow">
				<div class="card-body">
					${ state }
					<div><a class="text-white-50 small" href="<c:url value="/he-thong/chinh-sua-profile"></c:url>">Tắt thông báo này</a></div>
				</div>
			</div>
		</c:if>
	</div>
...
<div class="card shadow mb-4">
	<div class="card-header py-3">
		<h6 class="m-0 font-weight-bold text-primary">Chỉnh sửa Profile</h6>
	</div>
	<div class="card-body">
		<c:url var="post_url" value="/he-thong/chinh-sua-profile"></c:url>
