				...
				<div class="card-body">
					...
					<div>
						<a class="text-white-50 small"
							href="<c:url value="/he-thong/gan-thu-hoi-quyen-tai-khoan-user/${ userPermissionForm.username }"></c:url>">Tắt
							thông báo này</a>
					</div>
				</div>
			</div>
...
<div class="card shadow mb-4">
	<div class="card-header py-3">
		<h6 class="m-0 font-weight-bold text-primary">Gán / Thu hồi quyền
			của User: "${ userPermissionForm.username }"</h6>
	</div>
	<div class="card-body">
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 col-sm-12">
				<c:url var="post_url"
					value="/he-thong/gan-thu-hoi-quyen-tai-khoan-user/${ userPermissionForm.username }"></c:url>
				<form:form method="POST" action="${ post_url }"
					modelAttribute="userPermissionForm">
						...
						<div class="form-group">
							...
							<div>
								<form:input path="username"
									cssClass="form-control text-box single-line" disabled="true"/>
