...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	<h1 class="h3 mb-0 text-gray-800">Trang quản trị/Tạo mới Role</h1>
</div>
	...
	<div class="col-lg-12 mb-4">
		<c:if test="${ state != null }">
			<div class="card bg-secondary text-white shadow">
				<div class="card-body">
					${ state }
					<div><a class="text-white-50 small" href="<c:url value="/he-thong/tao-moi-role"></c:url>">Tắt thông báo này</a></div>
				</div>
			</div>
		</c:if>
	</div>
...
<div class="card shadow mb-4">
	<div class="card-header py-3">
		<h6 class="m-0 font-weight-bold text-primary">Tạo mới Role</h6>
	</div>
	<div class="card-body">
		<c:url var="post_url" value="/he-thong/tao-moi-role"></c:url>
